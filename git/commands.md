...
| 17 | `git stash`                                           | Back stage concept after staging, like changes are made but it will not show in commit logs. (after staging) |
...
| 33 | `git pull upstream main`                              | 29-30 steps in single step                                                                                   |
...
| 41 | `git rm --cached gradle.properties`<br>               | Stop the Tracking of this file<br>                                                                           |
| 42 | `git commit -m "Stop tracking gradle.properties"`<br> | Commit after removing tracking of the file                                                                   |
